...
import { EmailOtpSchema } from '../validations/UserRegistrationValidations';
...
function OTPInput({ 
    ...
    // Reset OTP when component mounts or email changes
    useEffect(() => {
        setOtp(Array(6).fill(''));
    ...
    const handleOtpChange = (index, value, form) => {
        ...
        // Update formik field
        form.setFieldValue('emailOtp', newOtp.join(''));
    ...
    return (
        <>
            ...
            <div className="text-center mb-8">
                ...
                <div onClick={onChangeEmail}  className='flex cursor-pointer justify-center gap-3 items-center'>
                <button 
                    type="button"
                    
                    className="text-teal-600 r hover:text-teal-800 text-sm mt-2"
                >
                    ...
                    {({ isValid, touched, values }) => (
                        <Form className="space-y-6">
                            ...
                            <div>
                                ...
                                <ErrorMessage name="emailOtp" component="p" className="text-red-500 text-sm text-center" />
                            </div>
                            ...
                            <div className="text-center mb-6">
                                ...
                                {countdown > 0 ? (
                                    <div className="flex items-center py-2 justify-center gap-2 text-gray-600">
                                        ...
                                        <span>Resend code in <span className='text-teal-600 font-semibold'>{formatTime(countdown)}</span></span>
                                    </div>
                                ) : (
                                    <button
                                        type="button"
                                        ...
                                        disabled={loader}
                                        className="inline-flex cursor-pointer py-2 items-center gap-2 text-teal-600 hover:text-teal-700 font-medium transition-colors duration-200 disabled:opacity-50"
                                    >
    ...
    <button 
        disabled={loader || !isValid || values.emailOtp.length !== 6} 
        type='submit' 
    ...
    >
        {loader ? (<BeatLoader color="#fff" size={8} />) : ("Verify Email")}
    </button>
</div>
