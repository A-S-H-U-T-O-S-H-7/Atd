  ...
  return (
    <div className="bg-white/80 backdrop-blur-sm border border-white/20 rounded-2xl shadow-xl p-6 md:p-8">
      ...
      {showSameAddressOption && (
        <div className="mb-6">
          <label className={`flex items-center gap-3 cursor-pointer group ${!isCurrentAddressComplete ? 'opacity-50 cursor-not-allowed' : ''}`}>
            <div className="relative">
              ...
              <div className={`w-5 h-5 rounded border-2 transition-all duration-200 ${
                ...
                !isCurrentAddressComplete ? 'border-gray-200 bg-gray-100' : 
            ...
            <span className={`text-sm font-medium transition-colors duration-200 ${
              !isCurrentAddressComplete ? 'text-gray-400' : 
