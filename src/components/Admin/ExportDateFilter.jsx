      ...
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4">
        ...
        <div className="flex-1 relative">
          ...
          <input
            ...
            className={`w-full pl-10 pr-4 py-3 rounded-xl border transition-all duration-200 focus:outline-none focus:ring-2 text-base sm:text-sm ${
              isDark
          ...
          />
          {/* Mobile Label */}
          <span className={`absolute -top-2 left-3 px-1 text-xs font-medium sm:hidden ${
        ...
        {/* Separator */}
        <div className={`hidden sm:flex px-3 py-2 font-medium ${
          isDark ? "text-gray-400" : "text-gray-500"
        }`}>
          to
        </div>
        ...
        <div className="flex-1 relative">
          ...
          <input
            ...
            className={`w-full pl-10 pr-4 py-3 mt-5 rounded-xl border transition-all duration-200 focus:outline-none focus:ring-2 text-base sm:text-sm ${
              isDark
                ? "bg-gray-700/50 border-gray-600 text-gray-200 focus:border-emerald-500 focus:ring-emerald-500/20 placeholder-gray-400"
                : "bg-white border-emerald-300 text-gray-900 focus:border-emerald-500 focus:ring-emerald-500/20 placeholder-gray-500"
            }`}
