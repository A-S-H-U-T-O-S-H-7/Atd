...
const PDCDocument = ({
  ...
  if (hasDoc && fileName) {
    return (
      <button
        ...
        title={isLoading ? "Loading..." : "View PDC"}
      >
        {isLoading ? (
  ...
  return (
    <div className="p-2 rounded-lg bg-red-100 text-red-600 flex items-center justify-center cursor-not-allowed" title="PDC Missing">
      <FileText size={18} className="flex-shrink-0" />
