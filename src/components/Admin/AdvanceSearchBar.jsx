    ...
    <div className={`rounded-xl p-1 transition-all duration-300 ${
      ...
      <form onSubmit={handleSubmit} className="flex flex-col md:flex-row gap-2">
        ...
        <select
          ...
          className={`px-4 py-3 rounded-lg border-2 transition-all duration-200 font-medium flex-shrink-0 ${
            isDark
        ...
        <div className="flex-1 flex gap-2">
          ...
          <button
            ...
            className={`px-6 py-3 rounded-lg font-semibold transition-all duration-200 hover:scale-105 disabled:scale-100 disabled:opacity-50 disabled:cursor-not-allowed ${
              isDark
