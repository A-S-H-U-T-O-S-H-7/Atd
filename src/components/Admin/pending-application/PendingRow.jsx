...
const PendingRow = ({
  ...
  return (
    ...
    >
      ...
      <td className="px-6 py-4">
        <span
          className={`text-sm px-3 py-2 font-medium ${isDark ? " border rounded-md bg-cyan-400 border-cyan-800 text-gray-800" : "border rounded-md bg-cyan-300 border-cyan-400 text-gray-800"}`}
        >
          Send Mail
        </span>
      </td>
