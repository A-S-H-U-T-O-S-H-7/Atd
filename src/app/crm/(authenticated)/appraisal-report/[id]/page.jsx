...
const fetchEnquiry = async () => {
  try {
    const { appraisalCoreService } = await import('@/lib/services/appraisal');
    const response = await appraisalCoreService.getAppraisalReport(enquiryId);
    
    if (response.data.success) {
      console.log('📊 Full API Response:', response.data);
      
      // Create enquiry object with ALL required data for AppraisalReport
      const enquiryData = {
        ...
        address_id: response.data.application.address_id,
        // Include the full API response for AppraisalReport to use
